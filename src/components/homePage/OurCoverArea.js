...
export default function OurCoverArea() {
  return (
    <>
      <div className="relative pl-[20rem] mt-[5rem]">
        <TextWithBorder text="Our Cover Area" />
        <h2 className="pt-[4rem] pb-[6rem] text-[4rem]/18 w-[50%]">
          Conduct market research to understand industry trends, competition and
          customer behaviour.
        </h2>
        <OurCoverAreaSlider />
      </div>
      <div className="mt-[40rem] mx-[1rem] w-[90%] h-[2rem] border-t-5 border-(--ui-dark) relative">
