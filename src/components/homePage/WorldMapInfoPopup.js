...
export default function WorldMapInfoPopup({ country }) {
  return (
    <div className="absolute right-10 translate-y-[-80%] h-[20rem] w-[35rem] bg-white/90 rounded-4xl py-[2rem] px-[2rem] border shadow-2xl flex flex-col justify-between z-[10000]">
