...
export default function WhyChooseUs() {
  return (
    <div className="px-[20rem] py-[6rem] flex flex-col gap-[5rem] max-10xl:px-[10rem] max-5xl:px-[5rem]">
      <TextWithBorder text="Why Choose Us" />
      <h3 className="text-[4rem]/20 w-[80%] max-14xl:w-[95%]">
